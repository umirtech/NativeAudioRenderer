...
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_createAudioRendererNative(
...
extern "C"
JNIEXPORT jint   JNICALL
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_setDefaultStreamValuesNative(
...
extern "C"
JNIEXPORT jint   JNICALL
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_startAudioRendererNative(
...
extern "C"
JNIEXPORT jint  JNICALL
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_stopAudioRendererNative(
        JNIEnv *env, jobject clazz,jint trackIndexA) {
    if (trackIndexA < 100)
    {
...
extern "C"
JNIEXPORT jint  JNICALL
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_releaseAudioRendererNative(
        JNIEnv *env, jobject clazz,jint trackIndexA) {
    if (trackIndexA < 100)
    {
...
extern "C"
JNIEXPORT jint
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_writeDataNative(
...
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_setVolumeNative(
...
Java_com_umirtech_nativeaudiorenderer_NativeAudioRenderer_getVolumeNative(
